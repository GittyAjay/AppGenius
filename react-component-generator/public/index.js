document.addEventListener('DOMContentLoaded', function () {
  ...
  const welcomeTextContainer = document.querySelector('.chat-welcome-text') // Added reference to welcome text container
  const welcomeTextBox = document.querySelector('.welcomeTextContainer')
